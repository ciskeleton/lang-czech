...
$lang['email_failed_smtp_login'] = 'Nepodařilo se odeslat příkaz AUTH LOGIN. Chyba: %s';
...
$lang['email_no_smtp_unpw'] = 'Chyba: Je nutné poskytnout SMTP přihlašovací jméno a heslo.';
...
$lang['email_smtp_auth_pw'] = 'Nepodařilo se autentizovat pomocjí hesla. Chyba: %s';
$lang['email_smtp_auth_un'] = 'Nepodařilo se autentizovat pomocjí přihlašovacího jména. Chyba: %s';
